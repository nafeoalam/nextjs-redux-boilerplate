...
export default function SelfCareCourses({ recommendedCourses }) {
    ...
    return (
        <>
            <Container maxWidth="lg" className={styles.ReactSlickCourse}>
                <Typography variant="h2" align="center" gutterBottom>For Fans of JVN: Self Care Essentials</Typography>
                <NewSlider courses={recommendedCourses} />
            </Container>
            {
