...
import WorkshopsSlider from 'src/shared/WorkshopsSlider/WorkshopsSlider';
import allWorkshops from '../../../../public/assets/json_data/myWorkshop_data.json';
...
export default function WorkshopSliderHome() {
    ...
    return (
        <>
            ...
            <Container maxWidth="lg" className={styles.ReactSlickCourse}>
                <Typography variant="h2" align="center" gutterBottom>Join a Workshop</Typography>
                <WorkshopsSlider workshops={allWorkshops} />
            </Container>
            {
                smallScreen ? <div style={{ height: "5rem" }}></div> : <div style={{ height: "10rem" }}></div>
            }
